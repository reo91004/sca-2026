...
### 4.1d G200 PoI/window diagnostic 완료 (2026-05-11) ★

**목표**: G200 negative scout 가 단순 PoI miss 인지 확인하고, oracle PoI 의
선택 편향을 null 로 검증.
...
- Attack-compatible PoI choices:
  - M1 pred/slot/emp: 0/16 top-100.
  - M5 pred/slot: 1/16 top-100; M5 empirical γ-var best case also only 1/16.
  - per-candidate window max (`winmax`) 는 W=16-96 모두 0/16 top-100.
- Secret-referenced oracle:
  - W=16: M1 10/16, M5 10/16 top-100.
  - W=32: M1 14/16, M5 15/16 top-100.
  - W=96: M1 16/16, M5 16/16 top-100.
- Self-oracle null:
  - W=16: null candidate top-100 already 53-58%.
  - W=32: null candidate top-100 77-80%.
